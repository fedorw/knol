function removeenzoknol_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
removeenzoknol_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				removeenzoknol_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
removeenzoknol_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
removeenzoknol_xmlhttpRequester.prototype.setupRequestEvent =
